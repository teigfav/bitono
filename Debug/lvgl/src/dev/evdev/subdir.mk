...
C_DEPS += \
./lvgl/src/dev/evdev/lv_evdev.d 

OBJS += \
./lvgl/src/dev/evdev/lv_evdev.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl/src/dev/evdev/%.o: ../lvgl/src/dev/evdev/%.c lvgl/src/dev/evdev/subdir.mk
...
clean: clean-lvgl-2f-src-2f-dev-2f-evdev

clean-lvgl-2f-src-2f-dev-2f-evdev:
	-$(RM) ./lvgl/src/dev/evdev/lv_evdev.d ./lvgl/src/dev/evdev/lv_evdev.o

.PHONY: clean-lvgl-2f-src-2f-dev-2f-evdev
