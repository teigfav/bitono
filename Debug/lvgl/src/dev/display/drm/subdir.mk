...
C_DEPS += \
./lvgl/src/dev/display/drm/lv_linux_drm.d 
...
lvgl/src/dev/display/drm/%.o: ../lvgl/src/dev/display/drm/%.c lvgl/src/dev/display/drm/subdir.mk
...
clean: clean-lvgl-2f-src-2f-dev-2f-display-2f-drm

clean-lvgl-2f-src-2f-dev-2f-display-2f-drm:
	-$(RM) ./lvgl/src/dev/display/drm/lv_linux_drm.d ./lvgl/src/dev/display/drm/lv_linux_drm.o

.PHONY: clean-lvgl-2f-src-2f-dev-2f-display-2f-drm
