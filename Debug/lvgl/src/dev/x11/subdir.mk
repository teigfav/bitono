...
C_SRCS += \
../lvgl/src/dev/x11/lv_x11_display.c \
../lvgl/src/dev/x11/lv_x11_input.c 

C_DEPS += \
./lvgl/src/dev/x11/lv_x11_display.d \
./lvgl/src/dev/x11/lv_x11_input.d 

OBJS += \
./lvgl/src/dev/x11/lv_x11_display.o \
./lvgl/src/dev/x11/lv_x11_input.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl/src/dev/x11/%.o: ../lvgl/src/dev/x11/%.c lvgl/src/dev/x11/subdir.mk
...
clean: clean-lvgl-2f-src-2f-dev-2f-x11

clean-lvgl-2f-src-2f-dev-2f-x11:
	-$(RM) ./lvgl/src/dev/x11/lv_x11_display.d ./lvgl/src/dev/x11/lv_x11_display.o ./lvgl/src/dev/x11/lv_x11_input.d ./lvgl/src/dev/x11/lv_x11_input.o

.PHONY: clean-lvgl-2f-src-2f-dev-2f-x11
